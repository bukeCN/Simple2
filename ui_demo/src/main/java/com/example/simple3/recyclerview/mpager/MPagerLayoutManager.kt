package com.example.simple3.recyclerview.mpager
...
class MPagerLayoutManager(
    private val spanCount: Int = 4,private val columnCount: Int = 2,
    private val spanSizeLookup: (position: Int) -> Int = { _ -> 1 }
    ...
    override fun scrollHorizontallyBy(
        ...
        val distance =
            if (scrollDistance <= 0 && dx <= 0 || scrollDistance >= maxScrollDistance && dx >= 0) 0
    ...
    private fun assignSpans(view: View, position: Int) {
        ...
        val height = height / columnCount
        view.layoutParams.width = MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY)
        view.layoutParams.height = MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY)
    }

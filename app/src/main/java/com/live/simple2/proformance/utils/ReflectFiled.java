package com.live.simple2.proformance.utils;

import com.live.simple2.utils.SunLog;
...
public class ReflectFiled<Type> {
    ...
    public synchronized Type get(boolean ignoreFieldNoExist)
        ...
        if (mField == null) {
            ...
            SunLog.w(TAG, String.format("Field %s is no exists.", mFieldName));
            return null;
        }
        Type fieldVal = null;
        try {
    ...
    public synchronized Type getWithoutThrow(Object instance) {
        ...
        try {
            ...
            SunLog.i(TAG, "getWithoutThrow, exception occur :%s", e);
    ...
    public synchronized boolean setWithoutThrow(Object instance, Type val) {
        ...
        try {
            ...
            SunLog.i(TAG, "setWithoutThrow, exception occur :%s", e);
        } catch (IllegalAccessException e) {
            SunLog.i(TAG, "setWithoutThrow, exception occur :%s", e);
        } catch (IllegalArgumentException e) {
            SunLog.i(TAG, "setWithoutThrow, exception occur :%s", e);

 ...
 */
class UPagerGridSnapHelper extends SnapHelper {
    ...
    protected RecyclerView.SmoothScroller createScroller(@NonNull RecyclerView.LayoutManager layoutManager) {
        ...
        if (mRecyclerView != null) {
            return new UPagerGridSmoothScroller(mRecyclerView);
        }
        return null;
    }
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        ...
        if (!(layoutManager instanceof UPagerGridLayoutManager)) {
            return RecyclerView.NO_POSITION;
        }
        final UPagerGridLayoutManager manager = (UPagerGridLayoutManager) layoutManager;
    ...
    public View findSnapView(RecyclerView.LayoutManager layoutManager) {
        View snapView = null;
        if (layoutManager instanceof UPagerGridLayoutManager) {
            UPagerGridLayoutManager manager = (UPagerGridLayoutManager) layoutManager;
    ...
    public int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager, @NonNull View targetView) {
        ...
        if (layoutManager instanceof UPagerGridLayoutManager) {
            ...
            if (viewDecoratedStart <= layoutCenter) {
                ...
                dx = UPagerGridSmoothScroller.calculateDx(manager, snapRect, targetRect);
                dy = UPagerGridSmoothScroller.calculateDy(manager, snapRect, targetRect);
            } else {
     ...
     */
    private void reacquireSnapList(UPagerGridLayoutManager manager, boolean forwardDirection) {
        if (!snapList.isEmpty()) {
            snapList.clear();
        }
    ...
    private int calculateDxToNextPager(UPagerGridLayoutManager manager, Rect targetRect) {
    ...
    private int calculateDyToNextPager(UPagerGridLayoutManager manager, Rect targetRect) {

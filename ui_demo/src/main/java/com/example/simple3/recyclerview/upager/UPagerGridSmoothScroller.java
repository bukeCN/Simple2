 ...
 */
class UPagerGridSmoothScroller extends LinearSmoothScroller {
    ...
    UPagerGridSmoothScroller(@NonNull RecyclerView recyclerView) {
    ...
    public static int calculateDx(UPagerGridLayoutManager manager, Rect snapRect, Rect targetRect) {
    ...
    public static int calculateDy(UPagerGridLayoutManager manager, Rect snapRect, Rect targetRect) {
    ...
    public static int calculateDx(UPagerGridLayoutManager manager, Rect snapRect, Rect targetRect, boolean isLayoutToEnd) {
        if (!manager.canScrollHorizontally()) {
            return 0;
        }
    ...
    public static int calculateDy(UPagerGridLayoutManager manager, Rect snapRect, Rect targetRect, boolean isLayoutToEnd) {
        if (!manager.canScrollVertically()) {
            return 0;
        }
